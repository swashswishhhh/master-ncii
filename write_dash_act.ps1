...
/**
 * AdminDashboardActivity — Mission management hub.
 *
...
'@
[System.IO.File]::WriteAllText("$base\app\src\main\java\com\example\servermasterncii\admin\AdminDashboardActivity.java", $dashActivity, $enc)
Write-Host "Dashboard activity written"
